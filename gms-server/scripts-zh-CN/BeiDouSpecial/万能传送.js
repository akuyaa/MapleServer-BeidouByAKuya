...
var bossmaps2 = Array(				
		...
		Array(211042300,500000,"扎昆                               #r（消耗50万金币）#b"), 	
		Array(240040700,500000,"暗黑龙王                       #r（消耗50万金币）#b") ,
		...
		Array(270030500,380000,"时间神殿雷卡               #r（消耗38万金币）#b") ,
				...
				Array(211070000,380000,"狮子王班雷昂            #r（消耗38万金币）#b") ,
				Array(271040000,380000,"希纳斯            #r（消耗38万金币）#b") ,
				Array(271040100,380000,"希纳斯boss点            #r（消耗38万金币）#b") ,
...
function levelBoss2(selection) {
    ...
    // 新增：金币不足判断
    if (cm.getMeso() < cost) {
        cm.sendOk("您的金币不足，需要 #r" + cost + "#k 金币才能进行此次传送。");
        cm.dispose();
        return;
    }
    cm.gainMeso(-cost);
